...
GLfloat light0Amb[] = {1.0, 0.0, 0.0, 1.0};
GLfloat light0Diff[] = {1.0, 0.0, 0.0, 1.0};
GLfloat light0Spec[] = {1.0, 0.0, 0.0, 1.0};
...
void sceneLights( )
{
  ...
  glLightfv(GL_LIGHT0, GL_SHININESS, light0Diff );
...
void idleCbk( )
{
  if(std::chrono::duration_cast< std::chrono::seconds >( std::chrono::high_resolution_clock::now( ) - fpsClock ).count( ) >= 1 )
  {
